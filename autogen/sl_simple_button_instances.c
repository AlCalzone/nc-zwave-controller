...
#include "sl_simple_button_button0_config.h"

sl_simple_button_context_t simple_button0_context = {
  .state = 0,
  .history = 0,
  .port = SL_SIMPLE_BUTTON_BUTTON0_PORT,
  .pin = SL_SIMPLE_BUTTON_BUTTON0_PIN,
  .mode = SL_SIMPLE_BUTTON_BUTTON0_MODE,
};

const sl_button_t sl_button_button0 = {
  .context = &simple_button0_context,
...
{
  sl_button_init(&sl_button_button0);
}

void sl_simple_button_poll_instances(void)
{
  sl_button_poll_step(&sl_button_button0);
}
